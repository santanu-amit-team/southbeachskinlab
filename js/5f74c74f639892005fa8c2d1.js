...
window.ANALYTICS_FUNCTIONS=[],SHGJQ(function(){SHGJQ(".shogun-component, .shg-c").on("click",function(c){var S=SHGJQ(c.target).parent();SHGJQ.each(window.ANALYTICS_FUNCTIONS,function(n,o){o(c,S)})})});
;(function($) {
  "use strict"
...
;(function($) {
  ...
  function shgMoveSlide(selector, index, isStep) {
    var container = $(selector).find(".shg-sld-slides")
    var current = container.find(".shg-sld-item.shg-sld-active")
    var next = current.next(".shg-sld-item")
    var prev = current.prev(".shg-sld-item")
    var slides = $(container.find(".shg-sld-item"))
  ...
  function shgActiveDot(selector, index) {
    var dots = $(selector).find(".shg-sld-dot")
