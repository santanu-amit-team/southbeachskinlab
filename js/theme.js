...
theme.MobileNav = (function() {
  ...
  var translateHeaderHeight = cache.$siteHeader.offset().top;
...
$(document).on('click', '.slidecart-continue', function() {
	if (window.SLIDECART_CLOSE) window.SLIDECART_CLOSE()
});
$('body').on('click', '.mobile-nav__sublist-link', function(e){
  e.preventDefault();
